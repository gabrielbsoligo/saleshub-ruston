...
interface Props {
  lead: Lead;
  onConfirm: (dataReuniaoISO: string, closerId: string) => void;
  onClose: () => void;
}
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative w-full max-w-sm bg-[var(--color-v4-card)] border border-[var(--color-v4-border)] rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="p-5 space-y-4">
          ...
          <div>
            <label className="block text-xs font-medium text-[var(--color-v4-text-muted)] mb-1">Closer que vai atender *</label>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              <label className="block text-xs font-medium text-[var(--color-v4-text-muted)] mb-1">Horário *</label>
