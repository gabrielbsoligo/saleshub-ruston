    ...
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div className="flex-1 overflow-auto p-6 space-y-6">
        <section className="bg-[var(--color-v4-card)] p-4 rounded-lg border border-[var(--color-v4-border)]">
          ...
          <h2 className="font-medium text-white mb-2">2. Instalar userscript <span className="text-xs text-slate-400 font-normal">v0.3.0</span></h2>
          ...
          <p className="text-xs text-slate-500">Clique no link acima para instalar/atualizar. Versão atual: <span className="text-slate-300 font-mono">0.3.0</span></p>
        </section>
        <section className="bg-[var(--color-v4-card)] p-4 rounded-lg border border-[var(--color-v4-border)]">
