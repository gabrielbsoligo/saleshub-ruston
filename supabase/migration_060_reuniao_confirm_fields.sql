...
--   1042431 Link Call código (text)       = SÓ o código da sala (var {{1}}; template prefixa https://meet.google.com/)
--   (1042427 Link da Call (url) DESCONTINUADO — prefixava http:// em código solto; não é mais gravado)
