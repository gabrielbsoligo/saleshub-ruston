-- =============================================================
-- Migration 005 — sync_lead_to_kommo: mapear canal 'recovery'
-- =============================================================
-- Bug: quando lead era criado com canal='recovery', o trigger
-- enviava origem_enum_id = NULL pro Kommo. Cliente ts (kommo.ts)
-- ja tinha recovery → 863727 no ORIGEM_ENUM; trigger nao.
-- =============================================================
...
BEGIN
    ...
    -- Origem enum (inclui recovery agora)
