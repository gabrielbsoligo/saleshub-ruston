-- migration_107_lead360_task_result.sql
-- P2.3 (parte 2) — kommo.lead_360 expõe o result da tarefa: por_tipo.tarefas ganha 'resultado'
-- e o item de timeline de tarefa concluída anexa ' -> <result>'. Depende da migration_106.
-- Reverter: reaplicar kommo.lead_360 da migration_087.
